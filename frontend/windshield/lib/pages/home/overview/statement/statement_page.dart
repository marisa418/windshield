...
// // class _StatementPageState extends ConsumerState {
// //   @override
// //   void initState() {
// //     super.initState();
// //     ref.read(apiProvider).getAllStatements().then((value) {
// //       if (value.isEmpty) {
// //         AutoRouter.of(context).replace(const StatementCreateRoute());
// //       }
// //     });
// //   }

// //   late final Future<List<Statement>> stateFuture =
// //       ref.read(apiProvider).getAllStatements();

//   @override
//   Widget build(BuildContext context) {
//     // final statement = ref.watch(statementProvider);
//     return FutureBuilder<List<Statement>>(
//       future: stateFuture,
//       builder: (context, snapshot) {
//         if (snapshot.connectionState == ConnectionState.waiting) {
//           return const CircularProgressIndicator();
//         } else if (snapshot.hasError) {
//           return const Text('Error loading financial statement');
//         } else {
//           final list = snapshot.data ?? [];
//           final List<int> month = [0];
...
//             print('hello');
//             if (month.length != 1) {
//               ref.read(statementProvider).setSelectedMonth(month[1]);
//             }
//             ref.read(statementProvider).setStatementList(list);
//           });
